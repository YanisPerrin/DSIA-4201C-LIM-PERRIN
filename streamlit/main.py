...
general_stats_categories=['Name','General Note','General Pace','General Shooting','General Passing','General Dribbling','General Defending', 'General Physical','Weak Foot (/5)','Skills (/5)']
